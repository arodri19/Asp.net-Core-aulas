using CasaDoCodigo.Aula2.Models;
using CasaDoCodigo.Aula2.Models.ViewModels;
        ...
        List<Produto> produtos = new List<Produto>
                {
                    ...
                    new Produto(4,"Rest",59.90m),
                    new Produto(5,"Design Patterns com Java",59.90m),
                    new Produto(6,"Vire o jogo com Spring Framework",59.90m),
                    new Produto(7,"Test-Driven Development",59.90m),
                    new Produto(8,"iOS: Programe para iPhone e iPad",59.90m),
                    new Produto(9,"Desenvolvimento de Jogos para Android",59.90m)
                 };
